...
func (ktr *KafkaTaskRunner) FillContext(context *framework.Context, application *framework.Application, task marathon.Task) error {
...
func (ktr *KafkaTaskRunner) RunTask(context *framework.Context, application *framework.Application, task map[string]string) error {
