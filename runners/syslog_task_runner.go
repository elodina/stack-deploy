...
func (str *SyslogTaskRunner) FillContext(context *framework.Context, application *framework.Application, task marathon.Task) error {
...
func (str *SyslogTaskRunner) RunTask(context *framework.Context, application *framework.Application, task map[string]string) error {
